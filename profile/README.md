...
### 1. **Base**  
**Image**: [`ghcr.io/bane-nor/base`](https://github.com/bn-apps/base)  
...
### 2. **Dotnet**  
**Image**: [`ghcr.io/bane-nor/dotnet`](https://github.com/bn-apps/dotnet)  
...
### 3. **Node**  
**Image**: [`ghcr.io/bane-nor/node`](https://github.com/bn-apps/node)  
...
### 4. **Python**  
**Image**: [`ghcr.io/bane-nor/python`](https://github.com/bn-apps/python)  
...
### 7. **Nginx**  
**Image**: [`ghcr.io/bane-nor/nginx`](https://github.com/bn-apps/nginx)  
